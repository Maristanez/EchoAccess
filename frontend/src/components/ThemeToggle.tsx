...
export function ThemeToggle({ className = "" }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`relative w-9 h-9 flex items-center justify-center rounded-full border border-surface-border text-text-primary/60 hover:text-text-primary hover:bg-surface-card transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lime focus-visible:ring-offset-2 focus-visible:ring-offset-ring-offset-page ${className}`}
    >
